...
zooAnimals.forEach(function (attributes) {
  animalNames.push(`Name: ${attributes.animal_name} Scientific: ${attributes.scientific_name}.`);
});
...
zooAnimals.filter(function (populationSize) {
  if (populationSize.population < 5) {
  largerPopulation.push(populationSize.animal_name);
  }
});
